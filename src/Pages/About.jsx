          ...
          <div className="row g-sm-4 g-2">
            <div className="col-6">
              <div className="fresh-image-2">
                <div>
                  <img src="../assets/images/inner-page/about-us/1.jpg" className="bg-img blur-up lazyload" alt />
                </div>
              </div>
            </div>
            <div className="col-6">
              <div className="fresh-image">
                <div>
                  <img src="../assets/images/inner-page/about-us/2.jpg" className="bg-img blur-up lazyload" alt />
                </div>
              </div>
            </div>
          </div>
  ...
  <section className="review-section section-lg-space">
    <div className="container-fluid">
      ...
      <div className="reviewer-box">
        ...
        <p>"I usually try to keep my sadness pent up inside where it can fester quietly as a mental illness."</p>
        <div className="reviewer-profile">
          <div className="reviewer-image">
            <img src="../assets/images/inner-page/user/1.jpg" alt="" />
          </div>
      ...
      <div className="reviewer-box">
        ...
        <h3>Top Quality, Beautiful Location</h3>
        <p>"My busy schedule leaves little, if any, time for blogging and social media."</p>
        <div className="reviewer-profile">
          <div className="reviewer-image">
            <img src="../assets/images/inner-page/user/2.jpg" alt="" />
          </div>
          <div className="reviewer-name">
      ...
      <div className="reviewer-box">
        ...
        <h3>Top Quality, Beautiful Location</h3>
        <p>"Professional, responsive, and able to keep up with ever-changing demand and tight deadlines."</p>
        <div className="reviewer-profile">
          <div className="reviewer-image">
            <img src="../assets/images/inner-page/user/3.jpg" alt="" />
          </div>
          <div className="reviewer-name">
      ...
      <div className="reviewer-box">
        ...
        <h3>Top Quality, Beautiful Location</h3>
        <p>"After being forced to move twice within five years, our customers had a hard time finding us."</p>
        <div className="reviewer-profile">
          <div className="reviewer-image">
            <img src="../assets/images/inner-page/user/4.jpg" alt="" />
          </div>
          <div className="reviewer-name">
            <h4>Terry G. Fain</h4>
            <h6>Photographer</h6>
